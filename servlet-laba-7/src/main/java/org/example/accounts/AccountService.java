...
public class AccountService {
    ...
    private void loadUsersFromDatabase() {
        Map<String, UserEntity> dbUsers = DatabaseConnection.loadAllUsers();
        for (UserEntity dbUser : dbUsers.values()) {
    ...
    public UserProfile getUserByLogin(String login) {
        ...
        if (user == null) {
            UserEntity dbUser = DatabaseConnection.getUserFromDb(login);
            if (dbUser != null) {
